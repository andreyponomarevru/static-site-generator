    ...
    <main class="main">
      <div class="about">
        ...
        <div class="content__column">
          ...
          <div class="content__text">
            <p class="text text_display_block">
              Начало истории крайне банально: в 2001-м родители подарили компьютер. За пару лет я наигрался в игры, мне стало скучно и я нашёл где-то в интернете учебник по HTML и CSS. С его помощью я  сделал свой первый сайт на narod.ru. Примерно в этоже время в школе мы проходили всякие Бэйсики и я увлёкшись программированием купил книгу Paulo Franca по C++. После этого ещё какое-то время поигрался с другими языками, с отвёрткой в руках поизучал собственный компьютер, повозился в командной строке и... наступил 2006-й год, время поступать в универ (<a href="http://www.mstu.edu.ru/" class="link">«Мурманский Государственный Технический Университет»</a>). 
            </p>

            <p class="text text_display_block">
              Ровно пол года я проучился на «Автоматизации технологических процессов и производств» и ещё около года на «Прикладной информатике». Параллельно я уже начал делать сайты на заказ - иногда с нуля под ключ, но чаще на базе «Битрикс» и «Joomla» и пр. CMS. Затем в силу личных проблем пришлось взять академический отпуск после которого университет я закончил уже не по IT-специальности. Во время академа я устроился web-дизайнером-стажёром в <a href="http://arcticmedia.ru/" class="link">Arctic Media Group</a>, но не успел проработать и пары месяцев, как всех накрыл приславутый кризис 2008-го. Затем была контрактная работа с другой небольшой мурманской студией, после чего я полностью ушёл во фриланс. Занимался в основном вёрсткой и интеграцией с разными CMS, немного веб-дизайном. Работал с частными клиентами и малым бизнесом. Какое-то время всё шло бодро и с энтузиазмом, но постепенно работа становилась всё однотипнее, монотонее и нарастала апатия. 
            </p>

            <p class="text text_display_block">
              Не нужно быть Вангой чтобы догадаться, что всё кончилось  выгоранием. Разочаровавшись в такой работе (к тому моменту я проработал 7-8 лет) я решил уйти в другую сферу, никак не связанную с IT. Спустя 4 года, в 2018-м, повзрослев и лучше в себе разобравшись я уже осознанно решил вернуться обратно и начать всё по-новой, но уже будучи более аккуратным в выборе того чем занимаюсь.
            </p>
          </div>
        </div>
